...
class Scene:
    def __init__(self, args : ModelParams, gaussians, load_iteration=None, shuffle=True, duration=None, loader=None, testonly=None, opt=None):
        ...
        if loader == "dynerf":
            duration = self.maxtime if self.maxtime is not None else 300
            scene_info = sceneLoadTypeCallbacks["Dynerf"](args.source_path, args.images, args.eval, duration=duration)
